...
tumor_path = os.path.join(raw_data,'RTS_nn')
lung_path= os.path.join(raw_data,'LM_nn')  
itr_dist = 10
...
outer_ring  = os.path.join(root_dir,'nn_outer_ring_5mm')  
...
for ind, cur_img_path in enumerate(image_paths):
    ...
    cur_lung_path = os.path.join(lung_path,'LM_' + file_name)
    cur_tumor_path = os.path.join(tumor_path,'RTS_' + file_name)
